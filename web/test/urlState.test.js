...
test('SCHEMA — has exactly 35 entries (11 inputs + 13 toggles + 1 neighbourhoods-mode + 1 zoning-changes-mode + 2 sort + 1 tab + 2 numbering + 1 subjectRoll + 1 salesN1 + 1 salesRise + 1 salesRadiusKm)', () => {
