...
// NOTE: year built and building size are POST-JOIN ONLY, by Jason's call on
// 2026-09-16. An earlier pass also cut them before the fetch; it was removed
// because these are the two filters an appraiser TUNES, and a pre-fetch cut
// puts a network round trip behind every nudge of a bound. Their accessors
// are tested above; there is deliberately no pre-join twin to test.
